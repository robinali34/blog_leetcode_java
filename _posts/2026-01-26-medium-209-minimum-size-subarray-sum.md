...
Step 2: For each starting position
  i=1 (start at index 0):
    ...
    binary search (lower bound) finds sums[4] = 8 >= 7
    length = 4 - 0 = 4
    
  i=2 (start at index 1):
    currTarget = 7 + sums[1] = 7 + 2 = 9
    binary search (lower bound) finds sums[5] = 12 >= 9
    length = 5 - 1 = 4
    
  i=3 (start at index 2):
    currTarget = 7 + sums[2] = 7 + 5 = 12
    binary search (lower bound) finds sums[5] = 12 >= 12
    length = 5 - 2 = 3
    
  i=4 (start at index 3):
    currTarget = 7 + sums[3] = 7 + 6 = 13
    binary search (lower bound) finds sums[5] = 12 >= 13? No, try next
    binary search (lower bound) finds sums[6] = 15 >= 13
    length = 6 - 3 = 3
    
  i=5 (start at index 4):
    currTarget = 7 + sums[4] = 7 + 8 = 15
    binary search (lower bound) finds sums[6] = 15 >= 15
    length = 6 - 4 = 2 ✓ (minimum)
    
  i=6 (start at index 5):
    currTarget = 7 + sums[5] = 7 + 12 = 19
    binary search (lower bound) finds sums[7] (end) → not found
