...
- [LC 1438: Longest Continuous Subarray With Absolute Diff Less Than or Equal to Limit on LeetCode](https://leetcode.com/problems/longest-continuous-subarray-with-absolute-diff/)
- [LeetCode Discuss — LC 1438: Longest Continuous Subarray With Absolute Diff Less Than or Equal to Limit](https://leetcode.com/problems/longest-continuous-subarray-with-absolute-diff/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/longest-continuous-subarray-with-absolute-diff/editorial/) *(may require premium)*
