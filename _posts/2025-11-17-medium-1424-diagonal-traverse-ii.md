...
### Solution 1: Hash Map Grouping (Java Optimized)
...
**Java Optimizations:**
- `groups.find(curr) != groups.end()` for map lookup (Java compatible)
...
### Solution 2: BFS Traversal (Java Optimized)
...
**Java Optimizations:**
- Structured bindings `auto [row, col]` for pair unpacking (Java)
