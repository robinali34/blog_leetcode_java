...
3. **ASCII Values**: Characters are automatically converted to integers in Java
...
2. **ASCII Conversion**: Characters automatically convert to integers in Java
