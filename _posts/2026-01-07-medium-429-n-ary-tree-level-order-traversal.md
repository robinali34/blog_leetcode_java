...
- [LC 429: N-ary Tree Level Order Traversal on LeetCode](https://leetcode.com/problems/n-ary-tree-level-order-traversal/)
- [LeetCode Discuss — LC 429: N-ary Tree Level Order Traversal](https://leetcode.com/problems/n-ary-tree-level-order-traversal/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/n-ary-tree-level-order-traversal/editorial/) *(may require premium)*
