...
class Solution {
        ...
        for(int i = 0; i < n; i++) {
            ...
            rtn = Math.max(rtn, Math.max(dp0, dp1));
        }
        return rtn;
    }
}
...
- [LC 487: Max Consecutive Ones II on LeetCode](https://leetcode.com/problems/max-consecutive-ones-ii/)
- [LeetCode Discuss — LC 487: Max Consecutive Ones II](https://leetcode.com/problems/max-consecutive-ones-ii/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/max-consecutive-ones-ii/editorial/) *(may require premium)*
