...
- [LC 50: Pow(x, n) on LeetCode](https://leetcode.com/problems/pow-x-n/)
- [LeetCode Discuss — LC 50: Pow(x, n)](https://leetcode.com/problems/pow-x-n/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/pow-x-n/editorial/) *(may require premium)*
