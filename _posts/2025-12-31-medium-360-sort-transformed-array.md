...
class Solution {
    public int[] sortTransformedArray(int[] nums, int a, int b, int c) {
        ...
        while(i <=j) {
            if(a >) {
                rtn[index--] = fn(nums[i]) >= fn(nums[j]) ? fn(nums[i++]) {
...
- [LC 360: Sort Transformed Array on LeetCode](https://leetcode.com/problems/sort-transformed-array/)
- [LeetCode Discuss — LC 360: Sort Transformed Array](https://leetcode.com/problems/sort-transformed-array/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/sort-transformed-array/editorial/) *(may require premium)*
