...
class Solution {
    ...
    public void dfs(int u) {
        ...
        rtn.add(u);  // Add to result (post-order)
    }
}
```
...
- [LC 113 on LeetCode](https://leetcode.com/problems/course-schedule-ii/)
- [LeetCode Discuss — LC 113](https://leetcode.com/problems/course-schedule-ii/discuss/)
