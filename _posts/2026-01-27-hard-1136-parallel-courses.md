...
- [LC 207: Course Schedule](https://robinali34.github.io/blog_leetcode_java/2025/10/20/medium-207-course-schedule/) - Check if all courses can be completed
...
- [LC 802: Find Eventual Safe States](https://robinali34.github.io/blog_leetcode_java/2026/01/15/medium-802-find-eventual-safe-states/) - Cycle detection in directed graph
...
- [LC 1136: Parallel Courses on LeetCode](https://leetcode.com/problems/parallel-courses/)
- [LeetCode Discuss — LC 1136: Parallel Courses](https://leetcode.com/problems/parallel-courses/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/parallel-courses/editorial/) *(may require premium)*
