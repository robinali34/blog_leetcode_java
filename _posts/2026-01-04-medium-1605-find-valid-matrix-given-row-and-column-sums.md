...
- [LC 1605: Find Valid Matrix Given Row and Column Sums on LeetCode](https://leetcode.com/problems/find-valid-matrix-given-row-and-column-sums/)
- [LeetCode Discuss — LC 1605: Find Valid Matrix Given Row and Column Sums](https://leetcode.com/problems/find-valid-matrix-given-row-and-column-sums/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/find-valid-matrix-given-row-and-column-sums/editorial/) *(may require premium)*
