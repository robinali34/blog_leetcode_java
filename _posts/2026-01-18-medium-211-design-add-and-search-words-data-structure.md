...
This problem extends [LC 208: Implement Trie](https://robinali34.github.io/blog_leetcode_java/2026/01/18/medium-208-implement-trie/) with **wildcard search** support. The key challenge is handling the `'.'` character which can match any letter.
