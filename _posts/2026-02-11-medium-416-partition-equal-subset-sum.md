...
- [LC 416: Partition Equal Subset Sum on LeetCode](https://leetcode.com/problems/partition-equal-subset-sum/)
- [LeetCode Discuss — LC 416: Partition Equal Subset Sum](https://leetcode.com/problems/partition-equal-subset-sum/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/partition-equal-subset-sum/editorial/) *(may require premium)*
