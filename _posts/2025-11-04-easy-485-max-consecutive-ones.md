...
categories: leetcode algorithm easy java arrays sliding-window problem-solving
...
- [LC 485: Max Consecutive Ones on LeetCode](https://leetcode.com/problems/max-consecutive-ones/)
- [LeetCode Discuss — LC 485: Max Consecutive Ones](https://leetcode.com/problems/max-consecutive-ones/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/max-consecutive-ones/editorial/) *(may require premium)*
