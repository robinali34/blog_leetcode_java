...
class Solution {
        ...
        sort(points /* elements of points */, [](auto u, auto v){
            return u[1] < v[1];
        });
        int pos = points[0][1];
        int arrows = 1;
...
- [LC 452: Minimum Number of Arrows to Burst Balloons on LeetCode](https://leetcode.com/problems/minimum-number-of-arrows-to-burst-balloons/)
- [LeetCode Discuss — LC 452: Minimum Number of Arrows to Burst Balloons](https://leetcode.com/problems/minimum-number-of-arrows-to-burst-balloons/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/minimum-number-of-arrows-to-burst-balloons/editorial/) *(may require premium)*
