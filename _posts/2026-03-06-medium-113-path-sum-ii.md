...
This is [LC 112 Path Sum](/2026/01/19/easy-112-path-sum/) extended to **collect all valid paths** instead of just returning true/false.
...
**Key idea:** This is [LC 112 Path Sum](/2026/01/19/easy-112-path-sum/) extended to **collect all valid paths** instead of just returning true/false.
...
- [LC 113: Path Sum II on LeetCode](https://leetcode.com/problems/path-sum-ii/)
- [LeetCode Discuss — LC 113: Path Sum II](https://leetcode.com/problems/path-sum-ii/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/path-sum-ii/editorial/) *(may require premium)*
