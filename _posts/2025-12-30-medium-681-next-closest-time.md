...
class Solution {
        ...
        int start = getMin(h, m), end = getMin(h + 24, m), day = getMin(24, 0);
        int h1 = 0, m1 = 0;
        for(int i = start + 1; i <= end; i++) {
            if(i >= day) i -= day;
            h1 = i / 60;
            m1 = i - h1 60;
            if(con[h1/10] && con[h1%10] && con[m1/10] && con[m1 % 10]) break;
        }
        char rtn[60];
...
- [LC 681: Next Closest Time on LeetCode](https://leetcode.com/problems/next-closest-time/)
- [LeetCode Discuss — LC 681: Next Closest Time](https://leetcode.com/problems/next-closest-time/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/next-closest-time/editorial/) *(may require premium)*
