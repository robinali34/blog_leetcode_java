...
- [LC 112: Path Sum on LeetCode](https://leetcode.com/problems/path-sum/)
- [LeetCode Discuss — LC 112: Path Sum](https://leetcode.com/problems/path-sum/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/path-sum/editorial/) *(may require premium)*
