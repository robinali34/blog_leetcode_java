...
categories: leetcode algorithm medium java arrays hash-map prefix-sum problem-solving
...
4. **Modern C++**: Uses `contains()` method (Java20)
...
- [LC 525: Contiguous Array on LeetCode](https://leetcode.com/problems/contiguous-array/)
- [LeetCode Discuss — LC 525: Contiguous Array](https://leetcode.com/problems/contiguous-array/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/contiguous-array/editorial/) *(may require premium)*
