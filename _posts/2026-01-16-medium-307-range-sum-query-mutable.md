...
- [LC 3477: Number of Unplaced Fruits](https://robinali34.github.io/blog_leetcode_java/2026/01/16/medium-3477-number-of-unplaced-fruits/) - Segment tree for leftmost query
...
- [LC 307: Range Sum Query - Mutable on LeetCode](https://leetcode.com/problems/range-sum-query-mutable/)
- [LeetCode Discuss — LC 307: Range Sum Query - Mutable](https://leetcode.com/problems/range-sum-query-mutable/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/range-sum-query-mutable/editorial/) *(may require premium)*
