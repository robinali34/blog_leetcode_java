...
class Solution {
        ...
        for(int num: nums) {
            ...
            prefixMods.put(prefixMod, prefixMods.getOrDefault(prefixMod, 0) + 1);
        }
        return cnt;
    }
}
...
- [LC 974: Subarray Sums Divisible by K on LeetCode](https://leetcode.com/problems/subarray-sums-divisible-by-k/)
- [LeetCode Discuss — LC 974: Subarray Sums Divisible by K](https://leetcode.com/problems/subarray-sums-divisible-by-k/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/subarray-sums-divisible-by-k/editorial/) *(may require premium)*
