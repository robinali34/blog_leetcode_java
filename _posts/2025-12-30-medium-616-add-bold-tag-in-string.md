...
- [LC 616: Add Bold Tag in String on LeetCode](https://leetcode.com/problems/add-bold-tag-in-string/)
- [LeetCode Discuss — LC 616: Add Bold Tag in String](https://leetcode.com/problems/add-bold-tag-in-string/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/add-bold-tag-in-string/editorial/) *(may require premium)*
