...
class Solution {
        ...
        // because the wait time `Math.max(t, moveTime)` dominates small differences in edge weights.
        // A simple 2D dist array is sufficient for this problem's constraints.
        long[][] dist(n, long[](m, Long.MAX_VALUE));
        dist[0][0] = 0;
        ...
        while (!pq.isEmpty()) {
            ...
            for (int d : dirs) {
                ...
                long nt = Math.max(t, (long)moveTime[nr][nc]) + w;
...
- [LC 3342: Find Minimum Time to Reach Last Room II on LeetCode](https://leetcode.com/problems/find-minimum-time-to-reach-last-room-ii/)
- [LeetCode Discuss — LC 3342: Find Minimum Time to Reach Last Room II](https://leetcode.com/problems/find-minimum-time-to-reach-last-room-ii/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/find-minimum-time-to-reach-last-room-ii/editorial/) *(may require premium)*
