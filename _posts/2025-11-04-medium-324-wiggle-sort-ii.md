...
categories: leetcode algorithm medium java arrays nth-element three-way-partition index-mapping problem-solving
...
class Solution {
    public void wiggleSort(int[] nums) {
        int n = nums.length;
        var midIt = nums.iterator() + n / 2;
        nth_element(nums.iterator(), midIt, nums.iterator());
        int median = *midIt;

        var vi = [n](int i) {return (1 + 2 i) % (n | 1);}
...
- [LC 324: Wiggle Sort II on LeetCode](https://leetcode.com/problems/wiggle-sort-ii/)
- [LeetCode Discuss — LC 324: Wiggle Sort II](https://leetcode.com/problems/wiggle-sort-ii/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/wiggle-sort-ii/editorial/) *(may require premium)*
