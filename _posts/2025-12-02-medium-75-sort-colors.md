...
- [LC 75: Sort Colors on LeetCode](https://leetcode.com/problems/sort-colors/)
- [LeetCode Discuss — LC 75: Sort Colors](https://leetcode.com/problems/sort-colors/discuss/)
- [LeetCode Editorial](https://leetcode.com/problems/sort-colors/editorial/) *(may require premium)*
...
```java
class Solution {
    public void sortColorsMinSwaps(int[] nums) {
        int n = nums.length;
        int p0 = 0, p2 = n - 1;
